            ...
            <div class="row">
                <div class="col-sm-5">
                    <div class="card-body">
                        <form class="form-horizontal">
                            ...
                            <div class="form-group row">
                                <label for="kasir" class="col-sm-4 col-form-label">Penjaga Perpustakaan</label>
                                <div class="col-lg">
                ...
                <div class="col-sm-5">
                    <div class="card-body">
                        <form>
                            <div class="form-group row">
                                <label for="supplier" class="col-sm-3 col-form-label">Anggota Peminjam</label>
                                <div class="col-7">
    ...
    $(function() {
        ...
        function addItem() {
            ...
            if (kodeBuku == "") {
                ...
                if (jumlah < 1) {
                    swal({
                        text: 'Stock Buku kurang, Buku Tidak Dapat Di Pinjam',
                        type: 'error'
                    })
                } else {
