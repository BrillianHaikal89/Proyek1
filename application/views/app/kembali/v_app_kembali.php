                ...
                <div class="col-sm-4">
                    <div class="card-body">
                        <form class="form-horizontal">
                            ...
                            <div class="form-group row">
                                <label for="kasir" class="col-sm-4 col-form-label">Anggota Pengembali</label>
                                <div class="col-8">
...
<script type="text/javascript">
    ...
    if (selisihWaktu > 0) {
        var dendaPerHari = 1000; // Set your denda per day value
        var totalDenda = selisihWaktu * dendaPerHari;

        $('#selisih').val(selisihWaktu);
        $('#denda').val(dendaPerHari);
        $('#total').val(totalDenda);
    } else {
        $('#selisih').val(0);
        $('#denda').val(0);
        $('#total').val(0);
    ...
    var cash = $('#bayar').val();
    var uangKembali = cash - $('#total').val();
